...
void CColorButton::DrawButton(CDC *pDC, const CRect &rc, int nState)
{
...
void CColorButton::DrawLine(CDC *pDC, const CPoint &start, const CPoint &end, COLORREF color)
{
	CPen newPen;
	CPen *oldPen;
...
void CColorButton::DrawBkgnd(CDC *pDC, CRect rc, COLORREF color)
{
	CBrush brSolid;
...
void CColorButton::DrawRim(CDC *pDC, CRect rc, int nState)
{
	COLORREF color;
...
void CColorButton::DrawText(CDC *pDC, CRect rc, CString strCaption, COLORREF clrText)
{
...
void CColorButton::SetColorToDefault()
{
